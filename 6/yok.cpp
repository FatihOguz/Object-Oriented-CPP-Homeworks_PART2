...
using namespace std;
namespace Yok_name	/* Yok namespace */
{
	template<class T>
	University<T> & Yok<T>::foundUni(University<T> * & uni,int &  UniSize,UniversityType uniType)
	{
	...
	template<class T>
	void Yok<T>::giveJob(University<T> * Uni,UniversityType uniType,string name,string surname,EmployeeType emp_type,Lecturer<T> * & Lecturers,Officer<T> * & Officers,Secretary<T> * & Secretarys,ResearchAsistant<T> * & ResearchAsistants,int & LecturersSize,int  & OfficersSize, int & ResearchAsistantsSize,int & SecretarysSize)
	{
