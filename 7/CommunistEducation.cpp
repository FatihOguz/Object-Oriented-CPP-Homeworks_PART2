...
using namespace std;
namespace CommunistEducation_name	/* CommunistEducation namespace */
{
	template<class T>
	University<T> & CommunistEducation<T>::foundUni(University<T> * & uni,int &  UniSize,UniversityType uniType)
	{
...
}/* the end of namespace CommunistEducation_name */
